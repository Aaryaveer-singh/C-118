...
elements_of_array=quick_draw_data_set[random_number];
document.getElementById("p3").innerHTML="Sketch to be drawn:"+" "+elements_of_array;
...
function draw(){
    ...
    if(drawn_sketch==sketch){
        answer_holder="set";
        score=score+1;
        document.getElementById("score_holder").innerHTML="score: "+score;
    }
}
